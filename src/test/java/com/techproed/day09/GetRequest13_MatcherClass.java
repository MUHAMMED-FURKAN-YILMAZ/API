...
public class GetRequest13_MatcherClass extends DummyTestBase {
    ...
    public void test() {
        ...
        response.then().assertThat().statusCode((Integer)expectedDataMap.get("statusCode")).
                body("data.employee_name[4]",equalTo(expectedDataMap.get("besinciCalisan")),
                        "data.id",hasSize((Integer) expectedDataMap.get("calisanSayisi")),
                        "data.employee_salary[-2]",equalTo(expectedDataMap.get("sondanIkinciCalisanMaasi")),
